...
func (r *enrollmentRoleAssignmentsResource) UpgradeState(_ context.Context) map[int64]resource.StateUpgrader {
...
func v0ToV1StateUpgrader(ctx context.Context, req resource.UpgradeStateRequest, resp *resource.UpgradeStateResponse) {
	...
	resp.Diagnostics.Append(req.State.GetAttribute(ctx, path.Root("enrollment_role_assignments"), &rawAssignments)...)
	if resp.Diagnostics.HasError() {
		return
	}
