...
var (
	_ resource.Resource              = &groupDeclarationResource{}
	_ resource.ResourceWithConfigure = &groupDeclarationResource{}
)

// NewGroupDeclarationResource is a helper function to simplify provider implementation.
func NewGroupDeclarationResource() resource.Resource {
	return &groupDeclarationResource{}
}

// groupDeclarationResource is the resource implementation.
type groupDeclarationResource struct {
	client            *v2.ClientWithResponses
	deletionsDisabled bool
}

// Configure adds the provider configured client to the resource.
func (r *groupDeclarationResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *groupDeclarationResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_group_declaration"
}

// Schema defines the schema for the resource.
func (r *groupDeclarationResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *groupDeclarationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan groupDeclarationResourceModel
...
func (r *groupDeclarationResource) CreateGroup(ctx context.Context, resp *resource.CreateResponse, plan *groupDeclarationResourceModel) error {
...
func (r *groupDeclarationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Get current state
	var state groupDeclarationResourceModel
...
func (r *groupDeclarationResource) ReadGroup(ctx context.Context, resp *resource.ReadResponse, state *groupDeclarationResourceModel) error {
...
func (r *groupDeclarationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *groupDeclarationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
...
func (r *groupDeclarationResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
